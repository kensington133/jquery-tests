$(function(){
	...
	console.log('Test 2 - jQuery');
	console.time('test2');
		test2();
	console.timeEnd('test2');

	console.log('Test 3 - jQuery');
	console.time('test3');
		test3();
	console.timeEnd('test3');

	console.log('Test 4 - jQuery');
	console.time('test4');
		test4();
	console.timeEnd('test4');

	console.log('Test 5 - jQuery');
	console.time('test5');
		test5();
	console.timeEnd('test5');

	console.log('Test 6 - jQuery');
	console.time('test6');
		test6();
	console.timeEnd('test6');

	console.log('Test 7 - jQuery');
	console.time('test7');
		test7();
